...
# set paths
# output paths
track_ids_save_path = "data/preprocessed/track_ids.npy"
filtered_data_save_path = "data/preprocessed/collab_filtered_data.csv"
sparse_matrix_save_path = "data/preprocessed/sparse_matrix.npz"
# input paths
...
def create_interaction_matrix(history_data:dd.DataFrame, track_ids_save_path, save_matrix_path) -> csr_matrix:
    ...
    save_sparse_matrix(sparse_matrix, save_matrix_path)
...
def main():
    ...
    # create the interaction matrix
    create_interaction_matrix(user_data, track_ids_save_path, sparse_matrix_save_path)
